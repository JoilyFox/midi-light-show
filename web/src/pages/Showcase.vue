...
<template>
  <div class="mx-auto max-w-[1100px] px-6 py-12 flex flex-col gap-12">
    <!-- identity -->
    <header>
      <p class="font-mono text-[11px] tracking-[.28em] uppercase text-filament">
        Design system · Filament
      </p>
      <h1 class="mt-3 text-[40px] font-semibold tracking-[-.02em] leading-none">
        Component library
      </h1>
      <p class="mt-4 max-w-[60ch] text-text-dim">
        ...
        —
        <code class="font-mono text-filament text-[13px]"
    ...
    <Card title="Chip · GroupChip · StatusDot">
      <div class="flex flex-col gap-5">
        <div class="flex flex-wrap items-center gap-3">
          ...
          <span class="flex items-center gap-2 text-[13px] text-text-dim"
            ><StatusDot state="online" /> online</span
          >
          <span class="flex items-center gap-2 text-[13px] text-text-dim"
            ><StatusDot state="offline" /> offline</span
          >
        </div>
